...
INSERT INTO Artist (artist_id, name) Values (3, 'Alanis Morissete');
INSERT INTO Artist (artist_id, name) Values (4, 'Ella Fitzgerald');
INSERT INTO Artist (artist_id, name) Values (5, 'Billie Ellish');

-- TRACK INSERTS 
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (1, 4, 1, 5,  'Bury a Friend', 240);
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (2, 4, 1, 5, 'Lovely', 360);
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (3, 4, 1, 5, 'Copy cat', 840);
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (4, 9, 2, 3, 'Ironic', 244);
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (5, 9, 3, 3, 'Perfect', 230);
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (6, 9, 2, 3, 'Feel your love', 248);
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (7, 3, 5, 2,  'Just by my own',  250);
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (8, 9, 3, 2, 'Superman', 249);
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (9, 3, 5, 2, 'All or nothing',  260);
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (10, 3, 5, 2,  'Donation', 220);
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (11, 3, 6, 2, 'Bad religion', 290);
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (12, 2, 7, 4, 'Oops', 200);
INSERT INTO Track (track_id, genre, album, artist, title, length) VALUES (13, 2, 7, 4, 'Can anyone explain', 210);
